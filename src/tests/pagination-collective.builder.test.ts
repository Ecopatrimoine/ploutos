...
//  - chemin 2-feuilles : marqueur de centrage (entretoise region flex:1 1 0) present
...
describe("pagePrevoyanceColl — pagination adaptative (builder)", () => {
  ...
  it("CCN lourde -> 2 feuilles : feuille 1 audit CENTRE, feuille 2 obligations + DDA, rien perdu", () => {
    ...
    // centrage : la region (entretoises flex:1 1 0) est sur la feuille 1, pas la feuille 2
